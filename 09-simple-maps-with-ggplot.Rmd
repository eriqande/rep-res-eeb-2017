...
# We can't just throw down a theme_void() because we still need to legends!
...
to those purists who would tell me that rainbow colors are not good for showing quantitative scales---I disagree with 
them, unabashedly...behold the following and try to argue that you can read the values more easily off the blue plot above...)
```{r}
eb2 <- elbow_room1 + 
