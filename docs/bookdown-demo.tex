...
\begin{Shaded}
\begin{Highlighting}[]
\OtherTok{NA} \NormalTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{west_coast <-}\StringTok{ }\NormalTok{states %>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(region %in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"california"}\NormalTok{, }\StringTok{"oregon"}\NormalTok{, }\StringTok{"washington"}\NormalTok{))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ca_df <-}\StringTok{ }\NormalTok{states %>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(region ==}\StringTok{ "california"}\NormalTok{)}
...
\NormalTok{ca_county <-}\StringTok{ }\NormalTok{counties %>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(region ==}\StringTok{ "california"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cacopa <-}\StringTok{ }\KeywordTok{left_join}\NormalTok{(ca_county, pop_and_area, }\DataTypeTok{by =} \StringTok{"subregion"}\NormalTok{) %>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{people_per_mile =} \NormalTok{population /}\StringTok{ }\NormalTok{area)}
...
\StringTok{  }\KeywordTok{geom_text}\NormalTok{(}\DataTypeTok{data =} \NormalTok{sisquoc, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{label =} \NormalTok{name), }\DataTypeTok{angle =} \DecValTok{60}\NormalTok{, }\DataTypeTok{hjust =} \DecValTok{0}\NormalTok{, }
            \DataTypeTok{color =} \StringTok{"yellow"}\NormalTok{, }\DataTypeTok{nudge_x =} \NormalTok{.}\DecValTok{0001}\NormalTok{, }\DataTypeTok{nudge_y =} \NormalTok{.}\DecValTok{0004}\NormalTok{, }\DataTypeTok{size =} \FloatTok{4.5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{get_googlemap}\NormalTok{(}\DataTypeTok{center =} \KeywordTok{c}\NormalTok{(-}\FloatTok{121.595}\NormalTok{, }\FloatTok{36.075}\NormalTok{), }\DataTypeTok{zoom =} \DecValTok{15}\NormalTok{, }\DataTypeTok{maptype =} \StringTok{"terrain"}\NormalTok{) %>%}
\StringTok{  }\KeywordTok{ggmap}\NormalTok{() }
\end{Highlighting}
\end{Shaded}
...
\NormalTok{bc %>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(state_or_province:sub_location, longitude, latitude)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{bc %>%}\StringTok{ }
\StringTok{  }\KeywordTok{count}\NormalTok{(sector, region, area)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{bc %>%}
\StringTok{  }\KeywordTok{count}\NormalTok{(sector, region)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{wiwa <-}\StringTok{ }\KeywordTok{readRDS}\NormalTok{(}\StringTok{"inputs/breeding_wiwa_isotopes.rds"}\NormalTok{)}

\CommentTok{# look at the range of the lat longs}
\KeywordTok{range}\NormalTok{(wiwa$lat)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{range}\NormalTok{(wiwa$long)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{intermitt <-}\StringTok{ }\NormalTok{streams %>%}
\StringTok{  }\KeywordTok{subset}\NormalTok{(., STREAMTYPE ==}\StringTok{ "INTERMITTENT"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sebastes_stillwater <-}\StringTok{ }\KeywordTok{readRDS}\NormalTok{(}\StringTok{"inputs/sebastes_locations.rds"}\NormalTok{) %>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(LATITUDE_M >}\StringTok{ }\FloatTok{36.55}\NormalTok{, }
         \NormalTok{LATITUDE_M <}\StringTok{ }\FloatTok{36.575}\NormalTok{,}
         \NormalTok{LONGITUDE_M >}\StringTok{ }\NormalTok{-}\FloatTok{121.975}\NormalTok{,}
         \NormalTok{LONGITUDE_M <}\StringTok{ }\NormalTok{-}\FloatTok{121.925}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
