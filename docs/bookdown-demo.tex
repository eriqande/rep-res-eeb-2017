...
\item[Tina Cheng]
Tina is a graduate student in EEB. Shis going to be leading the session
during the first week of the course when Kristen and Eric are still on
spring break, and then she is going to be joining in on the fun with us
for the remainder of the quarter until she has to travel off to Baja,
TA-ing the ``supercourse'' during the last four weeks of the quarter.
\end{description}
...
that there will be some fun things to do to see what sorts of things are
possible.
...
\item
  \textbf{bookdown:} This package is what I used to create this course
