...
\section{Create an RStudio Project with Your Own
Data}\label{create-an-rstudio-project-with-your-own-data}
...
about the data and the ways that you would like to analyze it.
